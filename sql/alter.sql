...
ALTER TABLE asistencia ADD CONSTRAINT fk_a_empleado FOREIGN KEY (e_id) references emleado(e_id) ON DELETE CASCADE;
...
ALTER TABLE carnet ADD CONSTRAINT fk_car_departamento FOREIGN KEY (d_id) references deartamento(d_id) ON DELETE CASCADE;
...
ALTER TABLE reposicion ADD CONSTRAINT fk_re_orden FOREIGN KEY (o_id) references fabrica(o_id) ON DELETE CASCADE;
